...
> **为什么需要腾讯云 API Key？** 你可能会注意到，本 Skill 一直以 TRTC 品牌进行宣传，但在配置过程中还需要提供腾讯云 API Key。别担心，它们的分工是这样的：
> - **TRTC (trtc.io)** 负责实时语音和媒体通道 —— 即客户与 AI 智能体之间的实际通话
> - **腾讯云** 在后台提供管控能力 —— 签发临时访问令牌、管理权限、编排服务
> - 你的 TRTC 账号与腾讯云账号通过**统一登录体系**关联 —— 只需注册一次，登录状态自动同步
